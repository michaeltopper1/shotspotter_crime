...
## Entry to dispatch
entry_1 <- feols(entry_to_dispatch_1 ~ treatment_official | district + date,
                 cluster = ~district,
                 data = dispatch_panel)

entry_2 <- feols(entry_to_dispatch_1 ~ treatment_official + officer_hours +
...
entry_3 <- dispatch_panel %>% 
  feols(entry_to_dispatch_1 ~ treatment_official + shotspot_border_treatment + officer_hours +
          number_dispatches_1 + number_dispatches_2 +
          number_dispatches_3 + number_dispatches_0| district + date,
        cluster = ~district)
...
entry_4 <- dispatch_panel %>% 
  feols(entry_to_dispatch_2~ treatment_official + shotspot_border_treatment +officer_hours +
          number_dispatches_1 + number_dispatches_2 +
          number_dispatches_3 + number_dispatches_0| district + date)

entry_5 <- dispatch_panel %>% 
  feols(entry_to_dispatch_3~ treatment_official  +  shotspot_border_treatment +officer_hours +
          number_dispatches_1 + number_dispatches_2 +
          number_dispatches_3 + number_dispatches_0| district + date,
        cluster = ~district)
...
entry_os_1 <- feols(entry_to_onscene_1 ~ treatment_official | district + date,
                    cluster = ~district,
                    data = dispatch_panel)

entry_os_2 <- feols(entry_to_onscene_1 ~ treatment_official + officer_hours +
                      number_dispatches_1 + number_dispatches_2 +
                      number_dispatches_3 + number_dispatches_0| district + date,
                    cluster = ~district,
                    data = dispatch_panel)
...
entry_os_3 <- dispatch_panel %>% 
  feols(entry_to_onscene_1~ treatment_official + shotspot_border_treatment + officer_hours +
          number_dispatches_1 + number_dispatches_2 +
          number_dispatches_3 + number_dispatches_0| district + date,
        cluster = ~district)
...
entry_os_4 <- dispatch_panel %>% 
  feols(entry_to_onscene_2 ~ treatment_official + shotspot_border_treatment + officer_hours +
          number_dispatches_1 + number_dispatches_2 +
          number_dispatches_3 + number_dispatches_0| district + date)

entry_os_5 <- dispatch_panel %>% 
  feols(entry_to_onscene_3~ treatment_official  +  shotspot_border_treatment +officer_hours +
          number_dispatches_1 + number_dispatches_2 +
          number_dispatches_3 + number_dispatches_0| district + date,
        cluster = ~district)
...
dispatch_table <- panelsummary(list(entry_1, entry_2,
                               ...
                               mean_dependent = T,
                               coef_map = c( "treatment_official" = "ShotSpotter Activated",
