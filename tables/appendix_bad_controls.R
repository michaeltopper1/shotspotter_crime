...
footnotes <- map(list("* p < 0.1, ** p < 0.05, *** p < 0.01",
                      ...
                      Number of 911 Dispatches which are Priority 1 and Officer Availability, which are not
                  ...
                  Number 911 Dispatches is the number of Priority 1 911 dispatches.
                  Officer Availability is the number of police officer hours.
