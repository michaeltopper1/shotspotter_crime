...
p2_3 <- dispatch_panel %>% 
  feols(entry_to_dispatch_suspicious_auto_p2 ~treatment + officer_hours +
          number_dispatches_1 + number_dispatches_2 + 
          number_dispatches_3 + number_dispatches_0| district + date) %>% 
  tidy_estimates("Suspsicious Auto", 2)
...
p2_5 <- dispatch_panel %>% 
  feols(entry_to_dispatch_battery_jo_p2 ~treatment + officer_hours +
          number_dispatches_1 + number_dispatches_2 + 
          number_dispatches_3 + number_dispatches_0| district + date) %>% 
...
p3_5 <- dispatch_panel %>% 
  feols(entry_to_dispatch_selling_narcotics_p3 ~treatment + officer_hours +
          number_dispatches_1 + number_dispatches_2 + 
          number_dispatches_3 + number_dispatches_0| district + date) %>% 
...
descriptions %>% 
  ...
  ggplot(aes(term_expand, estimate)) +
  geom_point() +
