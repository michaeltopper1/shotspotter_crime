...
## Main Results:
  - For other reported crimes:
    - +1 minute in call-to-dispatch (23%)
    - +2 minutes in call-to-on-scene (14%)
  - Lower arrest rates + lower gun victimization
]
---
# Contribution:
### Rigorous analysis on a wide-spread police technology, whose consequences are relatively unknown.
...
### High Priority
  ...
  - 911/ShotSpotter handled by same units:
...
* <font color="blue"> $\beta$ - average change in average daily response time </font>
